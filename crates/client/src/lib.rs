...
mod tests {
    ...
    async fn get_client() -> ProntoClient {
        INIT.call_once(|| {
            simple_logger::init_with_level(log::Level::Debug)
                .expect("Failed to initialize testing logger");
        });
    ...
    async fn test_get_bubble_list() {
        ...
        let _response = client
            .bubble_list()
            .await
            .expect("Failed to get bubble list");
    }

    #[tokio::test]
    async fn test_get_bubble_info() {
        let client = get_client().await;
        let bubble_list = client
            .bubble_list()
            .await
            .expect("Failed to get bubble list");
        ...
        let _response = client
            ...
            .await
            .expect("Failed to get bubble info");
    }
    ...
    async fn test_get_bubble_history() {
        ...
        let bubble_id = bubble_list.bubbles[0].id;
        let _response = client
            .bubble_history(bubble_id, None)
            .await
            .expect("Failed to get bubble history");
    }
