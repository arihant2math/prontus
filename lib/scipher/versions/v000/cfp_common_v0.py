...
class CfpCommonV0(cfp_common.CfpCommon):
    ...
    list_weights = {
        nltk.Nonterminal("CFP_TOPIC_SECTION"): (1, nltk.Nonterminal("CFP_TOPIC_LIST")),
        nltk.Nonterminal("LOC_SECTION"): (0.5, nltk.Nonterminal("LOC_LIST")),
        nltk.Nonterminal("ORGS_SECTION"): (1, nltk.Nonterminal("ORGS_LIST")),
        nltk.Nonterminal("STEER_SECTION"): (1, nltk.Nonterminal("STEER_LIST")),
        nltk.Nonterminal("KEYNOTE_SECTION"): (7, nltk.Nonterminal("KEYNOTE_LIST")),
        nltk.Nonterminal("PC_SECTION"): (5, nltk.Nonterminal("PC_LIST")),
    }

    recursive_terms = [
        nltk.Nonterminal("CFP_TOPIC_LIST"),
    ...
    newline_terms = {
        nltk.Nonterminal("CFP_GREETING"): 1,
    ...
    def calc_list_bits(self, msg_len, body_prod):
        ...
        used_lists = {
            w[1]: w[0] for l, w in self.list_weights.iteritems() if l in body_prod.rhs()
        }
