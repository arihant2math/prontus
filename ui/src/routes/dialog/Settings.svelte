...
<script>
    ...
    let maxSizeValue = $derived.by(() => {
        if (settings === null || settings.search.messages === null) {
            return;
        }
        return settings.search.messages.max_size / 1024 / 1024;
    });
                    ...
                    <div>
                        ...
                        >
                            ...
                            <Tabs.Content value="general" class="pt-3">
                                ...
                                <button type="button"
                                        class="text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700"
                                        onclick={logout}>
                                    Logout
                                </button>
                            </Tabs.Content>
                            ...
                            <Tabs.Content value="search" class="pt-3">
                                {#if settings.search.messages !== null && settings.search.messages.path !== undefined}
                                    <div>
                                        <b>Max Size</b> <input type="number" value={maxSizeValue} class="w-20" onchange={() => {
                            ...
                            <Tabs.Content value="updates" class="pt-3">
                                <ul class="space-y-4 mb-4 max-w-lg">
                                    <li>
                                        <input type="radio" id="settings-update-channel-stable" name="update-channel"
                                               value="stable"
                                               class="hidden peer" bind:group={settings.update.channel}
                                               onchange={saveSettings} disabled/>
                                        <RadioLabel target="settings-update-channel-stable">
                                            {#snippet svg()}
                                                <!--    TODO: insert-->
                                            {/snippet}
                                            {#snippet text()}
                                    ...
                                    <li>
                                        <input type="radio" id="settings-update-channel-rc" name="update-channel" value="rc"
                                               class="hidden peer" bind:group={settings.update.channel}
                                               onchange={saveSettings} disabled/>
                                        <RadioLabel target="settings-update-channel-rc">
                                            {#snippet svg()}
                                                <!--    TODO: insert-->
                                            {/snippet}
                                            {#snippet text()}
                                    ...
                                    <li>
                                        <input type="radio" id="settings-update-channel-beta" name="update-channel" value="beta"
                                               class="hidden peer" bind:group={settings.update.channel}
                                               onchange={saveSettings}/>
                                        <RadioLabel target="settings-update-channel-beta">
                                            {#snippet svg()}
                                            <!--    TODO: insert-->
                                            {/snippet}
                                            {#snippet text()}
                                    ...
                                    <li>
                                        <input type="radio" id="settings-update-channel-alpha" name="update-channel" value="alpha"
                                               class="hidden peer" bind:group={settings.update.channel}
                                               onchange={saveSettings}/>
                                        <RadioLabel target="settings-update-channel-alpha">
                                            {#snippet svg()}
                                                <!--    TODO: insert-->
                                            {/snippet}
                                            {#snippet text()}
