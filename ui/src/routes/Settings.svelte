            ...
            <div class="p-4 md:p-5 w-full">
                <form class="space-y-4">
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-xl">
                        ...
                        <li>
                            <input type="checkbox" id="error-reporting-option" value="" class="hidden peer" bind:group={settings.options.error_reporting} on:change={saveSettings}>
                            <OptionsLabel target="error-reporting-option">
                                ...
                                <p slot="body">Automatically report error via sentry.</p>
                            </OptionsLabel>
                        </li>
                    </ul>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white">
