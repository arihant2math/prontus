            ...
            <div class="p-4 md:p-5 w-full">
                <form class="space-y-4">
                    ...
                    <ul class="space-y-4 mb-4 max-w-lg">
                        <li>
                            <input type="radio" id="settings-theme-automatic" name="theme" value="Auto" class="hidden peer" bind:group={settings.theme} on:change={saveSettings}/>
                        ...
                        <li>
                            <input type="radio" id="settings-theme-light" name="theme" value="Light" class="hidden peer" bind:group={settings.theme} on:change={saveSettings}>
                        ...
                        <li>
                            <input type="radio" id="settings-theme-dark" name="theme" value="Dark" class="hidden peer" bind:group={settings.theme} on:change={saveSettings}>
