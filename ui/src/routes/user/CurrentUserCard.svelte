...
<div class="flex flex-row px-4 w-full border-b border-gray-500 z-40">
    ...
    <button class="px-2 rounded-lg hover:bg-gray-300 dark:hover:bg-slate-700" on:click={showSettings}>
    ...
    <DropdownMenu.Root>
        <DropdownMenu.Trigger>
            <button class="px-2 rounded-lg hover:bg-gray-300 dark:hover:bg-slate-700">
